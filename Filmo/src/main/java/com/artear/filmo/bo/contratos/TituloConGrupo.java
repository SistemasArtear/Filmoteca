...
public class TituloConGrupo {
    ...
    private boolean permiteEditarPasaLibreria;
    private boolean permiteRecontratar;
    ...
    public void setPasadasPendientes(int pasadasPendientes) {
        this.pasadasPendientes = pasadasPendientes;
    }
    
    public int getPasadasPendientes() {
        return this.pasadasPendientes;
    }
    ...
    public void setPermiteEditarPasaLibreria(boolean permiteEditarPasaLibreria) {
        this.permiteEditarPasaLibreria = permiteEditarPasaLibreria;
    }
    
    public boolean getPermiteEditarPasaLibreria() {
        return this.permiteEditarPasaLibreria;
    }
    
    public void setPermiteRecontratar(boolean permiteRecontratar) {
        this.permiteRecontratar = permiteRecontratar;
    }
    
    public boolean getPermiteRecontratar() {
        return this.permiteRecontratar;
    }
