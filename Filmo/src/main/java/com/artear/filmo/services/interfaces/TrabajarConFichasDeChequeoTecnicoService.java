 ...
 * 
 */
public interface TrabajarConFichasDeChequeoTecnicoService {
	...
	Boolean validarSegmentos(GuardarSegmentoRequest validarSegmentosRequest);

	void eliminarSegmentos(Integer nroFicha);

	void guardarSegmentos(GuardarSegmentoRequest segmentosRequest);
	...
	TitulosConContratosExhibidosResponse popupTitulosConContratosExhibidos(Integer nroFicha, String film);
	
	TitulosConContratosExhibidosResponse popupTitulosConContratosExhibidosSN(Integer nroFicha, String film);
	...
	void altaOModificacionDeRollos(AltaModifRolloRequest request);
	
	List<AsociarAContrato> buscarContratosParaAsociarLaCopia(
